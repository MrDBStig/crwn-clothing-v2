# CRWN Clothing v2 E-Commerce online store
...
- Every component has its own styled wrapper from styled-components
- Authentication via Firebase
- Online payments by Stripe
- Auto clear cart after successful payment or when logout
